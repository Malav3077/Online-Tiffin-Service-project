...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
       <title>Medium Gujarati Dish</title>
...
<body>
    <div class="container">
        <h2>Medium Gujarati Dish🍛<br><small style="color:red;font-size:19px">75 Rs.</small></h2>
        <ul class="responsive-table">
            ...
            <li class="table-row">
                ...
                <div class="col col-3" data-label="Amount">4 Nos</div>
            </li>
            <li class="table-row">
        ...
        {{-- <a class="button" href="{{ route('medium_g') }}">Order Now</a> --}}
        {{-- <a class="button" href="/create">Order Now</a> --}}
               @if(session()->has('user'))
                <a class="button" href="/mediumgujform">Order Now</a> <!-- Redirect to smallgujform -->
            @else
