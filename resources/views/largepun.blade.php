...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
       <title>Large Punjabi Dish</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Large Punjabi Dish🍛<br><small style="color:red;font-size:19px">350 Rs.</small></h2>
        <ul class="responsive-table">
            ...
            <li class="table-row">
                ...
                <div class="col col-2" data-label="Customer Name"> Palak Panner </div>
                <div class="col col-3" data-label="Amount">1 Nos</div>
            </li>
            <li class="table-row">
            ...
            <li class="table-row">
                ...
                <div class="col col-3" data-label="Amount">4 Pcs</div>
            </li>
        </ul>


                
        {{-- <a class="button" href="/largepunform">Order Now</a> --}}  

           @if(session()->has('user'))
                <a class="button" href="/largepunform">Order Now</a> <!-- Redirect to smallgujform -->
            @else
