...
<head>
    ...
    <title>Small Gujarati Dish</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Small Gujarati Dish🍛<br><small style="color:red;font-size:19px">50 Rs.</small></h2>
        ...
        {{-- <a class="button" href="/create">Order Now</a> --}}
                    ...
                    @if(session()->has('user'))
                <a class="button" href="/smallgujform">Order Now</a> <!-- Redirect to smallgujform -->
            @else
