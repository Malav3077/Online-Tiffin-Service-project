            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="/create" class="nav-item nav-link">Login
    ...
    <div class="row">
        ...
        <div class="tiffin gujarati">
            ...
            <div>
                ...
                <a href = "{{ route('large') }}"class="button">More Details</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="tiffin punjabi">
            ...
            <div>
                ...
                <p class="price">200 Rs.</p>
                  <a href = "{{ route('smallp') }}"class="button">More Details</a>
            </div>
        </div>
        <div class="tiffin punjabi">
            ...
            <div>
              ...
              <a href = "{{ route('mediump') }}"class="button">More Details</a>
            </div>
        </div>
        <div class="tiffin punjabi">
            ...
            <div>
               ...
               <a href = "{{ route('largep') }}"class="button">More Details</a>
            </div>
        </div>
    </div>
</div>
