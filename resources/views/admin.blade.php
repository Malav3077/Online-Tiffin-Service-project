...
<head>
    <meta charset="utf-8">
    <title>Tiffin Service - Admin</title>
...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="{{ asset('/create') }}" class="nav-item nav-link">UserLogin</a>
                        <a href="{{ asset('/admin') }}" class="nav-item nav-link active">Admin</a>
                    </div>
                </div>
            </nav>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="{{ route('authing') }}" method="POST" class="animated-form">
                    @csrf
                    <h2 class="h2"  style="margin-left">Admin</h2>
                    ...
                    <button type="submit" class="btn btn-primary"style="margin-left:90px;margin-top:15px" href>Login</button>
