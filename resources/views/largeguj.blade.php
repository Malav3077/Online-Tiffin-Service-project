...
<head>
    ...
    <title>Large Gujarati Dish</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Large Gujarati Dish🍛<br><small style="color:red;font-size:19px">120 Rs.</small></h2>
        <ul class="responsive-table">
            ...
            <li class="table-row">
                ...
                <div class="col col-2" data-label="Customer Name">Mix Sabji</div>
                <div class="col col-3" data-label="Amount">2 Nos</div>
            </li>
            <li class="table-row">
                <div class="col col-1" data-label="Job Id">2</div>
                <div class="col col-2" data-label="Customer Name">Sev Tameta Sak</div>
                <div class="col col-3" data-label="Amount">2 Nos</div>
            </li>
            <li class="table-row">
                <div class="col col-1" data-label="Job Id">2</div>
                <div class="col col-2" data-label="Customer Name">Chole Chana</div>
                <div class="col col-3" data-label="Amount">1 Nos</div>
            </li>
            <li class="table-row">
                <div class="col col-1" data-label="Job Id">3</div>
                <div class="col col-2" data-label="Customer Name">Roti</div>
                <div class="col col-3" data-label="Amount">6 Nos</div>
            </li>
            <li class="table-row">
                <div class="col col-1" data-label="Job Id">4</div>
                <div class="col col-2" data-label="Customer Name">Puri</div>
                <div class="col col-3" data-label="Amount">3 Nos</div>
            </li>
            <li class="table-row">
                <div class="col col-1" data-label="Job Id">5</div>
                <div class="col col-2" data-label="Customer Name">Dal-Bhat</div>
                <div class="col col-3" data-label="Amount">1 Nos</div>
            </li>
            <li class="table-row">
            ...
            <li class="table-row">
                ...
                <div class="col col-3" data-label="Amount">3 Pcs</div>
            </li>
        </ul>
        
        {{-- <a class="button" href="{{ route('large_g') }}">Order Now</a> --}}
          @if(session()->has('user'))
                <a class="button" href="/largegujform">Order Now</a> <!-- Redirect to smallgujform -->
            @else
