  ...
  <body>
    <div class="container">
      ...
      <form action="/storeorder" method="post">
        ...
        <input type="text" id="customer_name" name="customername" value="{{ session('customername', '') }}" />
        ...
        <input type="text" id="tiffin" name="tiffintype" value="Medium Punjabi Dish" readonly />

        <label for="cost">Cost:</label>
        <input type="number" id="cost" name="cost" value="250" readonly />
