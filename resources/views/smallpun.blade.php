...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
      <title>Small Punjabi Dish</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Small Punjabi Dish🍛<br><small style="color:red;font-size:19px">200 Rs.</small></h2>
        <ul class="responsive-table">
            ...
            <li class="table-row">
                ...
                <div class="col col-2" data-label="Customer Name">Panner Tikka Masala</div>
                <div class="col col-3" data-label="Amount">1 Nos</div>
            </li>
            <li class="table-row">
         ...
         {{-- <a class="button" href="{{ route('small_p') }}">Order Now</a> --}}
          @if(session()->has('user'))
                <a class="button" href="/smallpunform">Order Now</a> <!-- Redirect to smallgujform -->
            @else
